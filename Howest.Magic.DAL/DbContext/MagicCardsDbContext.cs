...
using TypeEntity = Howest.MagicCards.DAL.Entities.Type;


#nullable disable

namespace Howest.MagicCards.DAL.Contexts
{
    public partial class MagicCardsDbContext : DbContext
    {
        public MagicCardsDbContext()
        {
        }

        public MagicCardsDbContext(DbContextOptions<MagicCardsDbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS11;Database=mtg;Trusted_Connection=True");
            }
        }
